...
export function ExcludedModelsPanel({
  ...
  const activeCandidateId = activeIndex >= 0 ? visible[activeIndex]?.id : undefined;
  ...
  }, [activeCandidateId, activeIndex, autoFocus, listboxId, query]);
...
function ExcludedModelRow({
  ...
  const unavailable = disabled || lockedByRule;

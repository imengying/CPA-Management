import { useDeferredValue, useEffect, useEffectEvent, useMemo, useReducer, useRef, useState } from 'react';
...
export function LogsPage() {
  ...
  useEffect(() => {
    ...
    // store 订阅同步失效，避免旧响应抢在 effect 清理之前落地。

...
export type OAuthModelAliasCardProps = {
  ...
  onUpdate: (provider: string, sourceModel: string, alias: string) => void | Promise<void>;
  ...
  onRenameAlias: (oldAlias: string, newAlias: string) => void | Promise<void>;
...
export function OAuthModelAliasCard(props: OAuthModelAliasCardProps) {
  ...
  const diagramRef = useRef<ModelMappingDiagramRef>(null);

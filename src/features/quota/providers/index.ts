 ...
 *
 * 页面与认证卡片以擦除泛型的 QuotaAdapter 视图统一消费；
 * 具体状态类型由各 data.ts 的强类型导出承载。
 */
...
import type { QuotaProviderType, QuotaStore, QuotaStoreSetter } from './types';

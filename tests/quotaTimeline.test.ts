...
describe('buildTimelineLane', () => {
  ...
  test('codex: keeps the weekly lane on the account quota instead of a model quota', () => {
    const accountReset = at(2026, 7, 1, 20);
    const modelReset = at(2026, 6, 29, 20);
    const lane = buildTimelineLane({
      ...base,
      provider: 'codex',
      quota: {

...
describe('buildTrafficWindow', () => {
  test('merges rolling buckets and derives totals from that same window', () => {
    const traffic = buildTrafficWindow([
      [
        { time: '10:00-10:10', success: 8, failed: 2 },
        { time: '10:10-10:20', success: 4, failed: 0 },
      ],
      [
        { time: '10:00-10:10', success: 1, failed: 1 },
        { time: '10:10-10:20', success: 5, failed: 0 },
      ],
    ]);
  ...
  test('represents an empty window without inventing a success rate', () => {
    expect(buildTrafficWindow([])).toEqual({
      buckets: [],
      totalSuccess: 0,
      totalFailure: 0,
      total: 0,
